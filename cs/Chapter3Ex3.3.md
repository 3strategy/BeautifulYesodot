...
tags: [תנאים, מודולו, שארית חלוקה, לוגיקה,איומים,שח מט]
author: גיא סידס
mathjax: true
lang: he
---
...
רוצים להתחיל בטעימה אינטרקטיבית קצרה? [פתחו את תרגול האיומים בלוח שחמט]({{ '/interactive/Chapter3ChessThreatsInteractive/' | relative_url }}) והשלימו תנאי if ישירות מול הלוח.
{: .box-note}
