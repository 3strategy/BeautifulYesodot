...
## 9.1.1 חישוב ממוצע ציונים מעל הממוצע ועוד {#id9.1.1}
...
## 9.1.2 קליטת שמות יחודיים {#id9.1.2}
...
## 9.1.4 סכום במקומות זוגיים / אי זוגיים {#id9.1.4}
...
## 9.1.10
מערך יקרא מערך מאוזן אם מספר האיברים שערכם מעל אפס שווה למספר האיברים שערכם מתחת לאפס. {#id9.1.10}
כתבו פעולה (בשם `IsBalance`) המקבלת מערך מספרים שלמים ומחזירה true אם המערך מאוזן, או false אם המערך אינו מאוזן.


## 9.1.11 חשבון מילולי {#id9.1.11}
