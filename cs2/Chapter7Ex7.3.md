...
כתוב תכנית ראשית שתדפיס כמה מוניות צריך לשלוח ביום ד' (עבור 49 נוסעים), כמה ביום ה' (עבור 52 נוסעים), וכמה ביום ו' (עבור 60 נוסעים).

כדי לבצע את החישוב של כמות המוניות הנחוצה עבור מספר נוסעים נתון עליך לכתוב פעולה בשם `TaxisOrder` המקבלת פרמטר num1 שמכיל את מספר הנוסעים, ומחזירה את מספר המוניות הנדרש.

התכנית הראשית תקרא לפעולה 3 פעמים - קריאה אחת עבור כל יום, וכך תוכל להדפיס את מספר המוניות הדרושות.
