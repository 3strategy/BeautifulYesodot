...
את השאלה הבאה יש לפתור באתר [codeWars Perfect Number Verifier  בקישור זה](https://www.codewars.com/kumite/6343cebb6054f00030618f0d) לאחר שתצרו לעצמכם משתמש
...
## 7.3.11 ספרות זוגיות, וספרות שונות {#id7.3.11}
...
- אחרת, את המספר בהיפוך ספרות של כל זוג ספרות סמוך. 

לדוגמה: אם המספר הוא 1234, הפעולה תחזיר מספר חדש 2143  (כלומר כל זוג ספרות סמוך החליף סדר).
...
## 7.3.14 
מועמד לרישום לאוניברסיטה מגיש את ציוני תעודת הבגרות שלו. האוניברסיטה עורכת לציוניו ממוצע משוקלל על פי הקריטריונים הבאים: בכל מקצוע בו נבחן התלמיד בהיקף של 5 יח' הוא מקבל 20 נק' תוספת, ובכל מקצוע בו נבחן  {#id7.3.14}
בהיקף של 4 יח' הוא מקבל תוספת של 10 נק'.
...
[⬅ עִבְרוּ לתרגול 7.4 - קאטות **CodeWars** לא מסווגות](/cs2/Chapter7Ex7.4)

[⬅ עִבְרוּ לתרגול 7.3 כולל **פתרונות** - פונקציות המקבלות פרמטרים](/cs2/Chapter7Ex7.3withSolutions)

[⬅ חזרה לפרק 7 מורחב](/cs2//Chapter7Full)

[⬅ חזרה לפרק 7 המשך](/cs2//Chapter7FullB)

[⬅ עִבְרוּ לפרק 7 מקוצר](/cs2//Chapter7Short)
