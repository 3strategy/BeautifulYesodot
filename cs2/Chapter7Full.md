...
- יתרה מכך, פונקציות **מאפשרות לנו להשתמש בפתרון של בעיות שכבר פתרנו**, כדי לפתור בעיות חדשות. כדי להבין עד כמה חזקה הנקודה האחרונה ממולץ לצפות בפרופרסור הרשקוביץ [מסביר על ההבדל בין מתמטיקאי לפיזיקאי](https://youtu.be/P5nstHk0aaY?t=1646) 
...
**ניתן לקרוא לפונקציה** זו מכל מקום בתוך המחלקה (למשל מתוך Main) **על-ידי כתיבת שמה ואחריו סוגריים ריקים** וכמובן **;**
