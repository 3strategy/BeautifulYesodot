...
subtitle: "CodeWars"
author: גיא סידס
tags: [מערך, תרגול מערכים, חד ממדי,  n שכנים,CodeWars]
mathjax: true
lang: he
---
...
## 9.2.14 ממוצע n שכנים


נגדיר את המונח **ממוצע $$n$$ שכנים** כך:

• $$n$$ הוא מספר אי זוגי  
• נתון אינדקס `index` במערך  
• הערך באינדקס הנתון הוא האיבר האמצעי מבין `n` איברים רצופים  
• מחשבים ממוצע של `n` הערכים:
  חצי מהם משמאל לאינדקס, חצי מימין, והאיבר שבאינדקס באמצע  
• אם האינדקס קרוב לקצה המערך ואי אפשר לקחת `n` איברים (חריגה מגבולות המערך)  
  ⇒ מוחזר הערך שבאינדקס עצמו
...
לא ניתן לקחת איברים משמאל (חריגה מגבול המערך)

```text
הממוצע = הערך באינדקס = 3
```
...
לא ניתן לקחת 7 איברים סביב האינדקס

```text
הממוצע = הערך באינדקס = 12
```
