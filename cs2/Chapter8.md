...
layout: page
title: "פרק 8 מחרוזות"
subtitle: "string דומה למערך"
author: גיא סידס
tags: [מערך, מערכים,מחרוזת, מחרוזות, IndexOf, foreach]
mathjax: true
lang: he
---
...
{: .box-success}
משחק פתיחה לתרגול אינדקסים במחרוזת: [מגדל האינדקסים]({{ '/interactive/Chapter8StringIndexInteractive' | relative_url }})
...
[⬅ עִבְרוּ לתרגול 8.1 - מחרוזות](/cs2/Chapter8Ex8.1)
