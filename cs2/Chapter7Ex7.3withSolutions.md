...
## 7.3.1 כתיבת הגדרות של פונקציות {#id7.3.1}
...
## 7.3.5 סכום סדרת טבעיים {#id7.3.5}
...
## 7.3.6 מספר מושלם {#id7.3.6}
יש לכתבו פעולה המקבלת מספר שלם, ומחזירה true אם הוא מושלם. אחרת false.

מספר מושלם הוא מספר השווה לסכום כל מחלקיו. לדוגמא $$28 = 1 + 2 + 4 + 7 + 14 $$
...
<!-- 
יחכה למחרוזות
## 7.3.1 אנליזת הצבעות {#id7.3.1}
[text](https://www.codewars.com/kata/6343f62a2f5d2e0023639a26) -->


## 7.3.8 מעקב וטענות כניסה ויציאה {#id7.3.8}
...
## 7.3.10 ספרות חוזרות במספר {#id7.3.10}
...
{: .subq}
ב. (מצריך מערך מונים, קינון, או פונקציית עזר) כתבו פעולה בשם `IsDiffDigits` המקבלת מספר חיובי ומחזירה `true` אם כל ספרותיו שונות זו מזו, אחרת מחזירה `false`. 
...
## 7.3.13 מספר עולה יורד {#id7.3.13}
...
{   //  ============= גרסה בה התנאי העיקרי הוא הדגלים ================
    // העבודה עם דגלים נחוצה בעיקר מפני שבזמן הפתרון לא למדנו פונקציות
    // כשלא ניתן להחזיר תוצאה בתוך תנאי אין ברירה אלא להשתמש בדגלים
