...
track: extension
published: true
companion_commit: 29e43eb541435c0b2bed9bd14841af47bc246b4f
companion_previous: 0c0c792177b8e55c202e007909d5ea5d0e856589
---
...
[קוד השלב](https://github.com/3strategy/razortaba/tree/29e43eb541435c0b2bed9bd14841af47bc246b4f) · [השינוי מהשלב הקודם](https://github.com/3strategy/razortaba/compare/0c0c792177b8e55c202e007909d5ea5d0e856589...29e43eb541435c0b2bed9bd14841af47bc246b4f)
{% endif %}
...
Keeper הוא אדם או צוות שמטפל בחיה, ואינו משתמש של Identity. שומרים KeeperId ולא מעתיקים את שם המטפל לכל חיה. אם שם המטפל משתנה, הקשר נשאר נכון. Include טוען גם את הרשומה הקשורה. מצאו ברשימה את שם המטפל ובדקו שהוא מגיע מטבלת Keepers באמצעות הקשר.

## 2. מה קורה לחיות שכבר קיימות?

לא מוחקים את המסד. המיגרציה יוצרת מטפל לדוגמה בשם צוות המקלט. חיות ישנות נשארות זמנית ללא שיוך ומסומנות כך ברשימה; פותחים אותן בעריכה ובוחרים מטפל. בטפסים חדשים ובעריכה נדרשת בחירה תקינה. לכן KeeperId זמנית nullable במסד אך Required בקלט. פתחו חיה ישנה בעריכה, בחרו מטפל ושמרו את השיוך.
...
- [RazorTaba/Migrations/AppDbContextModelSnapshot.cs](https://github.com/3strategy/razortaba/blob/29e43eb541435c0b2bed9bd14841af47bc246b4f/RazorTaba/Migrations/AppDbContextModelSnapshot.cs)
