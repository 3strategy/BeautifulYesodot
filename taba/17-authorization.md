...
KeeperId הוא קשר עסקי בתוך מסד היישום. OwnerUserId מזהה את החשבון שיצר את הרשומה. מכיוון שהחשבונות במסד נפרד, זה אינו מפתח זר בין שני מסדי SQLite. הערך מגיע מהמשתמש המחובר בשרת, ולא מטופס.
...
רשומות שנוצרו לפני הפרק נשארות ללא בעלים ואינן ניתנות לעריכה דרך האתר. לא נותנים למשתמש הראשון בעלות אוטומטית על עבודת אחרים. לצורך התרגול יוצרים רשומות חדשות אחרי כניסה. מטפל הדוגמה נשאר זמין לבחירה אך אינו ניתן לשינוי.
