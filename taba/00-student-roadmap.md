...
subtitle: 45 דקות HTML ואז אתר רץ בסביבת הפיתוח; עיצוב, Markdown ו־Mermaid, ובהמשך Razor ו־CRUD; Git/GitHub מההתחלה ולפחות 50 commits לאורך השנה
lang: he
tags:
- CSharp
- HTML
...
{: .box-note}
בונים אתר בנושא שמעניין אתכם. מתחילים בתוכן ועיצוב, מוסיפים נתונים רק כשה־C# מוכן לכך, ומתקדמים לחשבונות והרשאות לפי הקצב. לא חייבים לסיים את כל ההרחבות כדי להגיש פרויקט טוב.

## איך מתחילים?

45 דקות ראשונות בקובץ HTML פשוט, ואז עוברים לסביבת הפיתוח ולאתר רץ. הדפדפן פתוח לצד העורך: משנים HTML ו־CSS ורואים את התוצאה. בהמשך מסבירים את Razor שכבר נמצא בפרויקט.
...
אתר אישי עם יצירה, קריאה, עריכה ומחיקה; בדיקת קלט; שמירה לאחר הפעלה מחדש; מאמר Markdown ותרשים שאתם מסבירים בעצמכם. עיצוב לא גמור אינו סיבה לעצור את לימוד הנתונים, אך אתר סטטי בלבד אינו הגשה שנתית מלאה.
