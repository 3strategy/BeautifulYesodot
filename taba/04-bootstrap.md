...
אזור הפתיחה משתמש בשתי עמודות במסך גדול. אזור הכרטיסים משתמש בשלוש עמודות מ־md ומעלה; במסך צר הכרטיסים נערמים. `g-4` קובע רווחים ו־`h-100` משווה גובה. בחרו בכל פעם מחלקת Bootstrap אחת ושנו אותה כדי לראות מה היא עושה. קובצי Bootstrap נמצאים בתיקיית `wwwroot/lib/bootstrap`.
