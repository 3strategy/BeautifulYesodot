...
quiz_window_start: "2026-05-13T08:00:00+03:00"
...
window.QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    promptHe: `רובוט מתחיל ב-${ltrCode("0")} וזז כך: צעד, קפיצה, צעד, חזור. לאיזה מספר הוא מגיע?\nמקרא: צעד = ${ltrCode("+1")}, קפיצה = ${ltrCode("+2")}, חזור = ${ltrCode("-1")}.`,
    choicesDir: "rtl",
    choices: [
      { key: "A", text: "1" },
      { key: "B", text: "2" },
  ...
  },
  {
    ...
    promptHe: `רובוט מתחיל בנקודה ${pointText(0, 0)} וזז כך: ימינה, למעלה, ימינה, למעלה, שמאלה. היכן הוא יסיים?\nמקרא: ימינה = ${deltaText(1, 0)}, שמאלה = ${deltaText(-1, 0)}, למעלה = ${deltaText(0, 1)}.`,
    choicesDir: "rtl",
    choices: [
  ...
  {
    id: 13,
    title: "שאלה 13: לולאת מקרא",
    promptHe: `רובוט מתחיל ב-${ltrCode("1")} וזז כך: קפיצה, חזרה, קפיצה, חזרה, קפיצה, חזרה, קפיצה. לאיזה מספר יגיע הרובוט?\nמקרא: קפיצה = ${ltrCode("+2")}, חזרה = ${ltrCode("-1")}.`,
    choicesDir: "rtl",
    choices: [
      { key: "A", text: "4" },
      { key: "B", text: "5" },
  ...
  },
  {
    ...
    promptHe: `רובוט מתחיל ב-${pointText(0, 0)} ופונה מזרחה. הוא זז כך: קדימה, ימינה, קדימה, שמאלה, קדימה, קדימה. היכן הוא מסיים ולאיזה כיוון הוא פונה?\nמקרא: קדימה = צעד אחד בכיוון הנוכחי, ימינה = סיבוב ימינה, שמאלה = סיבוב שמאלה.`,
    choicesDir: "rtl",
    choices: [
    ...
    correctKey: "A",
    explanationHe: `אחרי קדימה מגיעים ל-${pointText(1, 0)}, אחרי ימינה וקדימה ל-${pointText(1, -1)}, ואז שמאלה מחזיר למזרח ושתי תנועות קדימה נוספות מביאות ל-${pointText(3, -1)}.`,
    tags: ["סימולציית רובוט"],
  },
  {
    id: 19,
